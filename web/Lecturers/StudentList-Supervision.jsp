    ...
    <div class="column h-100" style="background-color:#FFFFFF;">
        <div class="custom-border p-4 w-100">
            <div class="is-flex is-justify-content-space-between is-align-items-center pb-2">
                <div>
                    <label class="has-text-weight-semibold has-text-grey-dark is-size-5">Student List With Supervisor</label>
            ...
            <div class="p-3">
                <table class="">
                    ...
                    <tr>
                        ...
                        <td class="is-size-7 has-text-centered has-text-right-mobile has-text-weight-semibold" data-label="Supervisor Name">Puan Nurul Huda binti Harun</td>
                        <td class="is-size-7 has-text-centered has-text-right-mobile has-text-weight-semibold" data-label="Matric ID">2023546821</td>
                        <td class="is-size-7 has-text-centered has-text-right-mobile has-text-weight-semibold" data-label="Session">Session Date</td>
                    </tr>
                    </tbody>
                </table>
            </div>
